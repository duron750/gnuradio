...
class wbfm_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Broadcast FM TX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Broadcast FM TX")
    ...
    def set_quadrature(self, quadrature):
        ...
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, self.quadrature, 200e3, 10e3, window.WIN_HAMMING, 6.76))
    ...
    def set_audio_rate(self, audio_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.audio_rate, 20e3, 1e3, window.WIN_HAMMING, 6.76))

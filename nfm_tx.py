...
class nfm_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "NFM TX Hackrf", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("NFM TX Hackrf")
        ...
        self.freq = freq = 145185000
        self.audio_rate = audio_rate = 48000

        ##################################################
        # Blocks
        ##################################################
        self._volume_range = Range(0, 10, 0.1, 3, 200)
    ...
    def set_quadrature(self, quadrature):
        ...
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, self.quadrature, 5e3, 2e3, window.WIN_HAMMING, 6.76))
    ...
    def set_audio_rate(self, audio_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.audio_rate, 12e3, 100, window.WIN_HAMMING, 6.76))

...
class wbfm_rx_rds_airspy(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "wbfm_rx_rds_airspy")
        ...
        self.freq_deviation = freq_deviation = 50e3
        ...
        self._rf_gain_range = qtgui.Range(0, 49, 1, 30, 200)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._freq_range = qtgui.Range(87, 108, 0.1, 101, 200)
        ...
        self.analog_fm_deemph_0_0 = analog.fm_deemph(fs=48000, tau=(freq_deviation/1e9))
...
def main(top_block_cls=wbfm_rx_rds_airspy, options=None):
